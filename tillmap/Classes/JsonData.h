...
public:
     ...
     * @param 需要被解析的字符串 
     */
    void operator<<(const unsigned char *)  throw(JsonException);
    
    /**
     * 解析json字符串  
     * @param 需要被解析的字符串 
     */
    void operator<<(std::string str) throw(JsonException);

	void operator<<(JsonNode&); 
    /**
     * 解析json字符串 
     * @param 需要被解析的字符串 
     */
    void operator<<(const char*) throw(JsonException);
    
    /**
     * 解析json字符串  
     * @param 需要被解析的字符串 
     */
    void decode(string) throw(JsonException);
    /**
     * 解析json字符串  
     * @param 需要被解析的字符串 
     */
    void decode(const char*) throw(JsonException);
    /**
     * 解析json字符串  
     * @param 需要被解析的字符串 
     */
    void decode(const unsigned char*) throw(JsonException);
    /** 
     * 编码json对象 
     * @param 输出的字符串 
     */
     ...
     * @param 输出的字符串 
     */
    void encodeUnsigned(unsigned char* &);
    /**
     * 编码json对象 
     * @param 输出的字符串 
     */
...
private:
    ...
    void addNode(JsonNode & node,const char* value);
};
